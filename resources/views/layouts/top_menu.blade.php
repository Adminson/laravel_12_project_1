    ...
    <div class="container-fluid d-flex h-100">
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->routeIs('setting.select_input_list.*') ? 'active' : '' }}">
                <a
                    href="{{ route('setting.select_input_list.index') }}"
                    class="menu-link"
                >
            ...
            <li class="menu-item {{ request()->routeIs('setting.ui_configuration.*') ? 'active' : '' }}">
                <a
                    href="{{ route('setting.ui_configuration.edit', 1) }}"
                    class="menu-link"
                >
                    <i class="menu-icon icon-base ti tabler-app-window"></i>
            ...
            <li class="menu-item {{ request()->routeIs('setting.audit.*') ? 'active' : '' }}">
                <a
                    href="{{ route('setting.audit.audit-full-list') }}"
                    class="menu-link"
                >
                    <i class="menu-icon icon-base ti tabler-app-window"></i>
