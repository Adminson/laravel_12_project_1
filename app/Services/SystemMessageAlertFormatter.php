...
class SystemMessageAlertFormatter
{
    ...
    public function format(
        ...
        $alertStyle = $this->resolveStyle($systemMessage->msg_type);

        return [
            'id' => $systemMessage->msg_id,
            'title' => $systemMessage->msg_title,
            'type' => $systemMessage->msg_type,
    ...
    protected function formatDescription(
        ...
        $date1 = optional($systemMessage->msg_start_date)->format('d-M-Y h:i A');
        $date2 = optional($systemMessage->msg_end_date)->format('d-M-Y h:i A');
