...
Route::prefix('admin')
    ->name('admin.')
    ->group(function () {
        Route::resource('ui-configurations', UiConfigurationController::class)
            ->except(['show', 'destroy']);
    });
...
Route::prefix('admin')->group(function () {
    Route::resource('ui-configurations', UiConfigurationController::class)
        ->except(['show', 'destroy'])
        ->names([
            'index' => 'admin_ui-configurations_index',
            'create' => 'admin_ui-configurations_create',
            'store' => 'admin_ui-configurations_store',
            'edit' => 'admin_ui-configurations_edit',
            'update' => 'admin_ui-configurations_update',
        ]);
});
